...
Recomendo a IDE VSCode por ser mais leve e por ter utilizado nesse código juntamente com o SDK .NET Versão 6.0


Abaixo tudo o que precisa saber sobre .NET para poder buildar e rodar este projeto.
# .NET Home
